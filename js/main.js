...
(function injectCoreStyles() {
  ...
  s.textContent = `
    ...
    .sk {
      display: block;
      border-radius: 8px;
      background: linear-gradient(90deg, #efe6dc 22%, #f8f2ea 40%, #efe6dc 58%);
      background-size: 840px 100%;
      animation: sf-shimmer 1.15s ease-in-out infinite;
    }
    .sk-img { width: 100%; aspect-ratio: 4/3; border-radius: 0; background-color: #f3ede8; }
    .sk-line { height: 11px; margin: 0 0 8px; }
    .sk-w-30 { width: 30%; }
    .sk-w-40 { width: 40%; }
    .sk-w-55 { width: 55%; }
    .sk-w-70 { width: 70%; }
    ...
    .sk-inbox .sk-col { flex: 1; min-width: 0; }
    .sk-msg {
      max-width: 58%;
      height: 42px;
      border-radius: 14px;
    ...
    .sk-msg.right { margin-left: auto; }
    .product_card--skeleton { pointer-events: none; box-shadow: none; }
    .sk-stat { height: 2.2rem; width: 4.2rem; }
    .sk-row td { padding: 1.1rem 0.8rem; }
